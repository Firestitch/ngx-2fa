...
export { Fs2faManageModule } from './app/modules/manage/manage.module';
...
export { Fs2faVerificationMethodsModule } from './app/modules/verification-methods/verification-methods.module';
...
export { ForceVerificationSetupGuard } from './app/modules/verification-setup/guards/force-verification-setup.guard';
